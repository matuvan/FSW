...
<body>
    ...
    <div class="payment-button">
        <button onclick="document.location='products.html'" class="continue">Continue Shopping</button>
        <button onclick="document.location='thankyou.html'" class="order">Order</button>
    </div>
    <div class="recompro">
